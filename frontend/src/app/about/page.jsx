...
// Page-specific metadata — this was missing entirely before, which meant this
// page inherited the homepage's exact title, description, AND canonical URL.
export const metadata = {
  title: "About North Ride — Car Booking for Islamabad, Gilgit & Skardu",
  description: "North Ride connects Islamabad and Rawalpindi to Gilgit-Baltistan with fixed-price rides, verified local drivers, and safe mountain travel across the Karakoram Highway.",
  alternates: {
    // CRITICAL FIX: without this, the page inherited the root layout's
    // absolute canonical ("https://northride.pk"), telling Google this
    // page's canonical URL was the homepage, not /about.
    canonical: "https://northride.pk/about",
  },
  openGraph: {
    title: "About North Ride — Car Booking for Islamabad, Gilgit & Skardu",
    description: "How North Ride connects the Twin Cities to Gilgit-Baltistan with fixed pricing and verified drivers.",
    url: "https://northride.pk/about",
  },
};
    ...
    <main className="min-h-[100svh] bg-white text-slate-900 selection:bg-emerald-100 selection:text-emerald-900 overflow-hidden hp-root">
      ...
      <section className="pt-32 md:pt-40 pb-16 px-6 relative">
        ...
        <div className="max-w-3xl mx-auto text-center animate-[hp-fadein_0.55s_ease_both]">
          ...
          <div className="animate-[hp-fadein_0.6s_ease_out_300ms_both]">
            {/* H1 now names the actual service + destinations instead of pure brand copy */}
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-slate-900 mb-6 leading-[1.1]">
              Car Booking to Gilgit &amp; Skardu, <br className="hidden md:block" />
              <span className="text-emerald-500 font-serif italic font-light">Made Simple.</span>
            </h1>
          </div>
          ...
          <p className="text-base md:text-xl text-slate-500 leading-relaxed max-w-2xl mx-auto font-medium animate-[hp-fadein_0.6s_ease_out_450ms_both]">
            North Ride connects Islamabad, Rawalpindi, Gilgit, and Skardu with safe, comfortable, fixed-price rides — built by locals who know the Karakoram Highway.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto bg-slate-50 rounded-3xl md:rounded-[3rem] overflow-hidden border border-slate-100 animate-[hp-fadein_0.8s_ease_out_both] hover:shadow-[0_20px_40px_rgba(15,23,42,0.05)] transition-all duration-300">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-stretch">
            ...
            <div className="p-8 md:p-16 lg:p-20 flex flex-col justify-center bg-white/50">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-center gap-3 text-[13px] font-semibold text-slate-700 bg-white p-3.5 rounded-xl border border-slate-100 shadow-sm shadow-slate-100/50">
                  <CheckCircle size={16} className="text-emerald-500 shrink-0" aria-hidden="true" /> Deep local knowledge
                </div>
                <div className="flex items-center gap-3 text-[13px] font-semibold text-slate-700 bg-white p-3.5 rounded-xl border border-slate-100 shadow-sm shadow-slate-100/50">
                  <CheckCircle size={16} className="text-emerald-500 shrink-0" aria-hidden="true" /> Fair, fixed prices
                </div>
              </div>

              {/* Internal link to the matching blog post — you already have
                  "about-north-ride-car-booking-northern-pakistan" in blogPosts.js,
                  which covers this same story in more depth. Link it both ways. */}
              <Link
                href="/blog/about-north-ride-car-booking-northern-pakistan"
                className="inline-flex items-center gap-2 mt-8 text-[13px] font-semibold text-emerald-600 hover:text-emerald-700"
              >
                Read the full story on how booking works →
              </Link>
            </div>
            ...
            <div className="bg-emerald-50/50 min-h-[250px] lg:min-h-full flex items-center justify-center border-t lg:border-t-0 lg:border-l border-emerald-100/50 relative overflow-hidden p-10">
              ...
              <Navigation size={120} strokeWidth={0.5} className="text-emerald-500/20 relative z-10 transform rotate-45 transition-transform duration-700 hover:scale-110" aria-hidden="true" />
            </div>
      ...
      <section className="py-24 max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16">
          <ValueCard
            icon={<Users size={24} className="text-emerald-600" aria-hidden="true" />}
          ...
          />
          <ValueCard
            icon={<Shield size={24} className="text-emerald-600" aria-hidden="true" />}
            title="Always Safe"
          ...
          />
          <ValueCard
            icon={<MapPin size={24} className="text-emerald-600" aria-hidden="true" />}
